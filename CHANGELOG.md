...
- Convert malformed nested JSON and missing required record fields in local-data
  imports into visible validation feedback while preserving the pre-import
  database through rollback.
