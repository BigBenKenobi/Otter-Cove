...
| Local composer utilities | 07, 08 | Complete the shared popover, attachments, document/workspace selection and command-backed optional actions using local or clearly simulated behavior. See the [execution-ready plan](local-composer-utilities-plan.md). |
